...
import com.dncovid19project.Adapter.CoronaAdapter;
import com.dncovid19project.Adapter.FAQAdapter;
import com.dncovid19project.Models.Corona;
import com.dncovid19project.Models.FAQ;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Dadra and Nagar Haveli and Daman and Diu").getJSONObject("districtData");
